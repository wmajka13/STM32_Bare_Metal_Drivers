...
&#x20; <img src="assets/SPI\_communication2.jpg" width="400" alt="Hardware Setup">
...
\* \*\*External Hardware:\*\* Arduino UNO (Slaver or Master), Logic Analyzer (Saleae clone), 3.3V-to-5V bidirectional level shifter.
...
<img src="assets/SPI\_com\_analyzer.png" width="800" alt="SPI Logic Analyzer Decode">
...
<img src="assets/i2c\_com\_analyzer.png" width="800" alt="I2C Logic Analyzer Decode">
